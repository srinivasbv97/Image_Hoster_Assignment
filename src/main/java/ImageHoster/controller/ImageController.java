...
public class ImageController {
    ...
    //We Obtain Logged User info from session object using HttpSession
    //We obtain the owner of the image using image id
    //Later use if condition to Pop-up error as expected
